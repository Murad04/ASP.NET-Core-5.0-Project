...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20220408042017_add_like_column_in_blogs_table")]
    partial class add_like_column_in_blogs_table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Message", b =>
                {
                    ...
                    b.Property<string>("Message_Context")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Message2", b =>
                {
                    ...
                    b.HasIndex("Message_Receiver");

                    b.HasIndex("Message_Sender");

                    b.ToTable("Messages2s");
                });

            modelBuilder.Entity("EntityLayer.Concrete.Message2TrashBin", b =>
                {
                    b.Property<int>("Message_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EntityLayer.Blog", b =>
                {
                    ...
                    b.HasOne("EntityLayer.Writer", "Writers")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Message2", b =>
                {
                    b.HasOne("EntityLayer.Writer", "ReceiverUser")
                        .WithMany("WriterReceiver")
                        .HasForeignKey("Message_Receiver");

                    b.HasOne("EntityLayer.Writer", "SenderUser")
                        .WithMany("WriterSender")
                        .HasForeignKey("Message_Sender");
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Message2TrashBin", b =>
                {
                    b.HasOne("EntityLayer.Writer", "ReceiverUser")
                        .WithMany("WriterReceiverT")
                        .HasForeignKey("Message_Receiver");

                    b.HasOne("EntityLayer.Writer", "SenderUser")
                        .WithMany("WriterSenderT")
                        .HasForeignKey("Message_Sender");
            ...
            modelBuilder.Entity("EntityLayer.Writer", b =>
                {
                    ...
                    b.Navigation("WriterReceiverT");

                    b.Navigation("WriterSender");

                    b.Navigation("WriterSenderT");
                });
